...
public static class Util
{
	...
	public static string GetBuildManagedFolder(string buildFilePath)
	{
		...
		else if (buildFolder.EndsWith(LINUX_32_APP_FILE_TYPE, StringComparison.OrdinalIgnoreCase)) // Linux 32-bit Standalone
		{
			//
			// example:
		...
		else if (buildFolder.EndsWith(LINUX_64_APP_FILE_TYPE, StringComparison.OrdinalIgnoreCase)) // Linux 64-bit Standalone
		{
			//
			// example:
